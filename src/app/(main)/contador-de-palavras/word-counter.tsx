...
export function WordCounter() {
  ...
  return (
    <article className="grid w-full flex-1 grid-cols-1 gap-4 md:grid-cols-[minmax(450px,1fr)_250px] lg:grid-cols-[1fr_300px] 2xl:gap-16">
      <Textarea
        className="h-full min-h-[250px] border bg-background/50 text-zinc-600 dark:border-stone-700 dark:bg-stone-800 dark:text-stone-300 dark:placeholder:text-stone-500"
